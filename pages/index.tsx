...
export default function Home() {
  return (
    <div className="h-screen">
      ...
      <main className="px-32 py-16 sm:flex items-center justify-between h-full text-white">
        <div className="mb-10  sm:mr-6">
          <p
            className="font-bold text-xl sm:text-3xl tracking-wide leading-8 text-gray-100
           selection:bg-pink-600 selection:text-white first-letter:text-7xl first-letter:text-pink-600 first-letter:font-bold
           "
          >
